...
"""
Filtro mediana: efectivo para operar en imágenes con ruido sal y pimienta
...
cv2.namedWindow('Filtro Mediana',cv2.WINDOW_AUTOSIZE)
cv2.createTrackbar('Tipo','Filtro Mediana',0,10,nothing)
while True:
        ...
        N = cv2.getTrackbarPos('Tipo', 'Filtro Mediana')
        if N!=0:
            
            N= 2*N + 1
            imagen = cv2.medianBlur(imagen,N)
        ...
        #Mostramos imagen  
        cv2.imshow('Filtro Mediana', imagen)
